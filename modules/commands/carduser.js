...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`https://api.leanhtruong.net/v2/info_user_facebook.php?api_key=LEANHTRUONG=JkCRKQSavfpK5lvdzxMXfkaO0eT9XsDrsJHRouAf971illVqdY=APIKEY=PLANFREE&id=${uid}`); 
  ...
  let bg = (
    await axios.get(encodeURI(`https://i.imgur.com/n9n21KP.png`), {
